...
public class ProductsPage extends BasePage {
    ...
    public WebElement resetAppElement;
    ...
    public void checkPageTitle(){
        Assert.assertEquals(pageTitleElement.getText(), "Swag Labs");
        LoggerUtility.info("The title of the page is Swag Labs");
    }
    ...
    public void checkProductsSubTitle(){
        Assert.assertEquals(productsElement.getText(), "Products");
        LoggerUtility.info("The SubTitle of the page is Products");
    }
